...
export const datiLezione = {
    ...
    produzioneRisposte: {
        ...
        esercizi: [
            { id: "u001_r1", domanda: "Dov'è l'albergo Ponte Vecchio?" },
            { id: "u001_r2", domanda: "Perché è comodo per i turisti?" },
            { id: "u001_r3", domanda: "Chi sono i clienti dell'albergo?" },
            { id: "u001_r4", domanda: "Chi è Victor?" },
            { id: "u001_r5", domanda: "Perché Victor è in Italia?" },
            { id: "u001_r6", domanda: "Chi è Yoko?" },
            { id: "u001_r7", domanda: "Perché Yoko è in Italia?" },
            { id: "u001_r8", domanda: "Chi sono Karl e Klaus?" },
            { id: "u001_r9", domanda: "Perché Karl e Klaus sono in Italia?" },
            { id: "u001_r10", domanda: "Chi è Olga?" },
            { id: "u001_r11", domanda: "Perché Olga è in Italia?" },
            { id: "u001_r12", domanda: "Chi è Mary?" },
            { id: "u001_r13", domanda: "Perché Mary è in Italia?" },
            { id: "u001_r14", domanda: "Chi è il signor Rossi?" }
        ]
    },
